"""Runtime data-source policies for real, debug, and simulation modes."""
...
def empty_status_data() -> dict:
    """Return explicit missing values; never synthesize production telemetry."""
...
def merge_status_data(
    ...
    """Merge status per field: real first, debug fallback, simulation virtual only."""
