...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/img/icon/橘子.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"border-radius:0px;}")
        ...
        self.label_7.setStyleSheet("image: url(:/img/icon/橘子.png);")
...
"")
        ...
        self.raw_video.setAutoFillBackground(False)
...
"")
    ...
    def retranslateUi(self, mainWindow):
        ...
        # 第一处修改：窗口标题栏文字
        mainWindow.setWindowTitle(_translate("mainWindow", "柑橘病虫害检测"))
        # 第二处修改：界面内左上角标题标签文字（原：YOLOv5检测界面）
        self.label_4.setText(_translate("mainWindow", "柑橘病虫害检测"))
